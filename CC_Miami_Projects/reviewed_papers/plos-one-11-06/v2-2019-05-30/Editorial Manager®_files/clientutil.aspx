...
function viewAuthorInvLetter(authorInvLetterCorrHistID, letterSecurityID)
{
	...
	var name = "viewLetter.aspx?id=" + authorInvLetterCorrHistID + "&lsid=" + letterSecurityID;
	openCenterWin(name,"viewLetter",1,1,0,0,0,0);
}
...
function openICSScorecard(peopleID, usid, documentID, msid, revision)
{
    var name = "IdentityConfidenceScorecard.aspx?peopleid=" + peopleID + "&usid=" + usid + "&documentid=" + documentID + "&msid=" + msid + "&revision=" + revision;
    openCenterWin(name,"ics_scorecard",1,1,0,0,0,0);
}


function openAuthorICSScorecard(authorID, documentID, msid, revision)
{
var name = "IdentityConfidenceScorecard.aspx?authorid=" + authorID + "&documentid=" + documentID + "&msid=" + msid + "&revision=" + revision;
openCenterWin(name,"ics_scorecard",1,1,0,0,0,0);
}


function openReviewerICSScorecard(reviewerID, documentID, msid, revision)
{
var name = "IdentityConfidenceScorecard.aspx?reviewerid=" + reviewerID + "&documentid=" + documentID + "&msid=" + msid + "&revision=" + revision;
openCenterWin(name,"ics_scorecard",1,1,0,0,0,0);
}
