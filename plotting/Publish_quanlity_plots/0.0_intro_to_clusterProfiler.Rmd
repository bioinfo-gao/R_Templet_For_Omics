...
---
title: "clusterProfiler used by Zhen Gao to produce koenrich files"
author: 
- name:  Zhen Gao
  email: zhen.gao@gmail.com
  affiliation: 
date: "`r Sys.Date()`"
output:
...
<!-- **_G Yu_** __*G Yu*__  eseentiall same thing, bold and italic -->
Another line of visible text.
        

__*G Yu*__ , **_G Yu_**, LG Wang, Y Han, QY He. clusterProfiler: an R package for comparing biological themes among gene clusters. **_OMICS: A Journal of Integrative Biology_** 2012, 16(5):284-287. doi:[10.1089/omi.2011.0118](http://dx.doi.org/10.1089/omi.2011.0118)
